      ...
      <div className="flex-align-center flex-justify-center margin-top-8 landscape-flex-column-centered">
        <div className="margin-0 w-form">
          <form className="width-full max-width-medium portrait-max-width-full flex-column-middle background-color-2 padding-8 radius-xl box-shadow-large z-1 padding-y-12 landscape-padding-2">
            ...
            <p className="text-align-center margin-top-2 landscape-margin-bottom-20">Deposit ETH to mint {currentSynth} at <span className="weight-bold text-color-4">{state.globalUtilization * 100}%</span> utilization</p>
            <img src="/images/Box-01.png" loading="lazy" alt="" className="width-32 height-32 margin-bottom-8" />
                ...
                <div className="width-full margin-bottom-4">
                  <div className="relative">
                    <input
                      ...
                      onInput={(e) => formState.values.pendingTokens = state.globalUtilization / state.tokenPrice * e.currentTarget.value}
                      type="number"
                  ...
                  <div className="relative">
                    <input
                      ...
                      onClick={(e) => e.currentTarget.select()}
                      onInput={(e) => formState.values.pendingCollateral =  e.currentTarget.value * state.tokenPrice / state.globalUtilization}
                      type="number"
          ...
          <div className="padding-8 padding-top-0 tablet-padding-top-0 landscape-padding-top-0 portrait-padding-top-0 flex-column expand">
            ...
            <div className="margin-top-8">
              <div className="flex-align-center flex-space-between">
                ...
                <GaugeLabel
                  label={`${(state.globalUtilization).toFixed(2)} CR`}
                  tooltip={`This is what your position will look like after minting. You will mint ${state.sponsorTokens} ${currentSynth}, utilizing ${state.utilization ? state.utilization * 100 : 0}% of your ${currentCollateral}`}
              ...
              <div className="relative z-1">
                <div className="flex-align-center flex-space-between margin-top-6 margin-bottom-4">
                  ...
                  <p className="text-xs margin-0">{(state.globalUtilization).toFixed(2)} ({state.globalUtilization * 100}% utilization)</p>
                </div>
                ...
                <div className="flex-align-center flex-space-between">
                  ...
                  <p className="text-xs margin-0">{(state.liquidationPoint).toFixed(2)} ({state.liquidationPoint * 100}% utilization)</p>
                </div>
              </div>
            </div>
          </div>
