...
import type { Empv2 } from "../Empv2";

export class Empv2__factory {
  static connect(address: string, signerOrProvider: Signer | Provider): Empv2 {
    return new Contract(address, _abi, signerOrProvider) as Empv2;
  }
}
