...
import type { Emp } from "../Emp";

export class Emp__factory {
  static connect(address: string, signerOrProvider: Signer | Provider): Emp {
    return new Contract(address, _abi, signerOrProvider) as Emp;
  }
}
