...
export const EthNodeUrl = 'https://fee7372b6e224441b747bf1fde15b2bd.eth.rpc.rivet.cloud';
export const EthNodeProvider = new providers.JsonRpcProvider(EthNodeUrl);
